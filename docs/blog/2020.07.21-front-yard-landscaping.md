...
As you can see, couple of the bushes had died. Per the conversation with the customer, a
...
rocks would be launched into the yard, sidewalk, or other location that they should not be. I
suggested that brick pavers be used as a barrier to prevent this from happening going
forward as nobdy would be willing to run over bricks with a lawn mower as it could
potentially destory the mower.
