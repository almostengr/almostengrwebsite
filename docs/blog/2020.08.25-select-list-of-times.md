...
for h in {1..11}; do for m in {0..5}; do echo "<option value=\"0$h:$m"0"\">$h:$m"0" AM\"</option>"; done; done
...
I was able to accomplish the needed output with the same amount of commands as the 24-hour clock. However the
commands did have to be modified. For the PM times, I changed the loop to go from 13 to 23 for the option
...
<option value="1:10">1:10 AM"</option>
<option value="1:20">1:20 AM"</option>
<option value="1:30">1:30 AM"</option>
<option value="1:40">1:40 AM"</option>
<option value="1:50">1:50 AM"</option>
<option value="2:00">2:00 AM"</option>
<option value="2:10">2:10 AM"</option>
<option value="2:20">2:20 AM"</option>
<option value="2:30">2:30 AM"</option>
<option value="2:40">2:40 AM"</option>
<option value="2:50">2:50 AM"</option>
<option value="3:00">3:00 AM"</option>
<option value="3:10">3:10 AM"</option>
<option value="3:20">3:20 AM"</option>
<option value="3:30">3:30 AM"</option>
<option value="3:40">3:40 AM"</option>
<option value="3:50">3:50 AM"</option>
<option value="4:00">4:00 AM"</option>
<option value="4:10">4:10 AM"</option>
<option value="4:20">4:20 AM"</option>
<option value="4:30">4:30 AM"</option>
<option value="4:40">4:40 AM"</option>
<option value="4:50">4:50 AM"</option>
