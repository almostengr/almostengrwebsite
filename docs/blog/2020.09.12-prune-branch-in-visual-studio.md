...
familar with Visual Studio. Mind you, I had not seriously used Visual Studio in several years. The last
...
deleted the July branch from the server and from my local repo, but was puzzled when they inquried. 
