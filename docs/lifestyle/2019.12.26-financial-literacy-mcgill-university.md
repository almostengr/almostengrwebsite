...
* it accrues interest immediatel
* usually has lower fees and interest rates than credit cards
* poeple often usually take out a larger balance for line of credit 
than for credit cards as they have lower rates 

#### Long Term Financing

* usually used for larger costs assiets, cars, or housese
...
* loans are amortized
* tpye of interest rate is a consideration. mortgage payments stay the same with fixed 
...
* factors include how long you've had credit for, outstadning balances, missed payments, amount of
...
I passed this section with 80% score. 80% was required to go on to the next section.
...
I passed with a 90%. Minimum is 80%
...
* kick off meeting; 
* write 1-3 words were you stand financially 
...
* include infomration that you need to stand where you are and where you would like to be 
...
* money markey = bonds less than 1 year 
...
* representativeness - similiar to stereotypes
