title: Lessons Learned as Production Support / Help Desk Agent
date: 2020.01.10
...
well as demostrated skills that others had not seen before. Hopefully my experiences 
...
step up and work both, as the primary for the applicatoin that I was 
...
received no pushback on requesting the day off on short notice. 
...
Larger vendors provide a manual or some kind of documatation for their 
...
to pasting bits and pieces of code from Stackoverflow and other websites, 
...
condusive to getting a lot of work done. I have discovered that some people 
...
know by following up immediately. If the IM is that important, they would have 
...
Email is one of those things that can easily get on your nerves. 
