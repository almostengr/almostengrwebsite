...
if (!defined('CIVICRM_UF_DSN')) {
  define( 'CIVICRM_UF_DSN'           , 'mysql://apbdrupal:qXK6YhWemG@plibrary.matrixneo.ddns.net:6220/pbdrupal?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  define( 'CIVICRM_DSN'          , 'mysql://apbdrupal:qXK6YhWemG@plibrary.matrixneo.ddns.net:6220/pbdrupal?new_link=true');
}
...
$civicrm_root = '/var/www/bitdrupal/sites/all/modules/civicrm';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/var/www/bitdrupal/sites/default/files/civicrm/templates_c/');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://civibit.matrixneo.ddns.net');
}
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', 'd5193d70dfbf4f254ff0d3d70ca09f8c');
}
...
// define( 'CIVICRM_MAIL_LOG', '/var/www/bitdrupal/sites/default/files/civicrm/templates_c//mail.log');
// }
