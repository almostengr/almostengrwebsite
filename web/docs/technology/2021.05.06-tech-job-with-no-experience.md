...
technology field. How would one go about getting a job in the field without experience?
...
and company property. However, I may talk about those projects at a high level, but not share the source
...
ramp before actually being able to do. As you see, my comment was about understanding what the video
...
So since I currently do (at the writing of this article)
C# at work, I decided to do these coding challenges in C#. This would allow me to advance
...
the purpose of NuGet packages and the syntax differences between the languages.
...
they will demonstrate to others that you know what you are talking about, also that you
can back up the talk (walk the walk, talk the talk), and help you provide proof that you know how to
do the work. If you want to take this to the next level, you can document your experiences on video 
of doing coding sessions or work that you do on freelance projects.
