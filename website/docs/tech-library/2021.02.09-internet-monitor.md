...
After updating to the latest [DD-WRT](https://dd-wrt.com)
...
This solution uses [Selenium Webdriver](https://www.selenium.dev/)
to connect to the [DD-WRT](https://dd-wrt.com)
...
[code repository](https://github.com/almostengr/internetmonitor).
